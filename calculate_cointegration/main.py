...
test_dataPath = "./2021-07-01_daily_min_price.csv"
table_path = "./20210701_formationtable.csv"



test_data = pd.read_csv(test_dataPath, index_col=False)
test_data = test_data.iloc[167:,:]
...
print(result["record"]["total_profit"])
