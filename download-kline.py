...
def download_daily_klines(symbols, num_symbols, intervals, dates, start_date, end_date, sv_path, folder, checksum):
  print("in")
  current = 0
  date_range = None
      ...
      for interval in intervals :
          for date in dates:
            ...
            if current_date >= start_date and current_date <= end_date:
              ...
              save_path = "{}/{}/{}/".format(sv_path,symbol.upper(), interval)
...
if __name__ == "__main__":
    ...
    download_daily_klines(symbols, num_symbols, args.intervals, dates, args.startDate, args.endDate, args.save_path, args.folder, args.checksum)
